...
// const PartnerPaymentService = require('../modules/partnerPayment/partnerPayment.service');
...
//         await PartnerPaymentService.requireVerifiedUpi({
...
//                         userToken,
//                         'Booking Accepted',
//                         'Your partner has accepted your booking.',
//                         {
            ...
            try {
                ...
                if (userToken) {
                    void sendExpoNotification(
                        userToken,
                        'Booking Accepted',
                        `Your booking has been accepted${safePartner?.name ? ` by ${safePartner.name}` : ' by a partner'}.`,
                        {
                            bookingId: getBookingKey(updated),
                            screen: 'Booking',
                        },
                        {
                            ...
                            eventId: `booking_${getBookingKey(updated)}_ACCEPTED`,
